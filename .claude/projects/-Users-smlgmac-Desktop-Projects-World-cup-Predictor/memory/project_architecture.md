...
users, audit_logs, teams (45 rows), elo_history, simulations, simulation_runs,
saved_scenarios, players (0 — needs API key), coaches (0 — needs API key),
match_results (49,304 rows), match_features, ml_models (5 rows), qualified_teams (43 rows)
...
- 43/48 teams confirmed as of June 2025 (5 inter-confederation playoff slots TBD)
